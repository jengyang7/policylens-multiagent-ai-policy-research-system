...
# gpt-5.4: $2.50/$15.00 per 1M tokens — best cost/quality for reasoning steps; supports cached input ($0.25)
LEAD_MODEL = "gpt-5.4"

# Fast/cheap bulk web-reading: parallel research subagents
# gpt-5.4-nano: $0.20/$1.25 per 1M tokens — 12.5× cheaper than lead; sufficient for structured Finding extraction
